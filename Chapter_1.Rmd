...
\qquad Kromě práci Edwarda Tufte velký vliv měli i publikace Wiliama S. Clevelanda. Cleveland se svým kolegou Robertem McGillem publikovali v roce 1984 článek o grafickém vnímání a také prováděl studie na toto téma. [@cleveland_mcgill]  Jedená z nejvíc známých je studie, kterou provedli mezi svými studenty, na rozdíl ve vnímání koláčových a sloupcových grafů. Studenti systematicky odhadováli hodnoty sloupcového grafu přesnějí oproti kolačovému grafu. Z tohoto důvodu se tato forma grafů nepoužívá ve vážných kvantitativních výzkumech. [@cleveland_priceonomics] Ve svých prácích *Visualizing data* z roku 1993 a *The Elements of Graphing Data* z roku 1994 Cleveland se zabýval principy visualizace. Definuje čtyři hlavní kategorie: jasnou vizi, jasnou srozumintelnsot, rozsah a obecnou strategii. [@cleveland1994] Nekteré z ních jsou podobné principů Tufte, ačkoli jeho práce v této oblasti předcházela práci Tufte.
