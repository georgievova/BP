...
\qquad Kromě práci Edwarda Tufte velký vliv měli i publikace Wiliama S. Clevelanda. Cleveland se svým kolegou Robertem McGillem publikovali v roce 1984 článek o grafickém vnímání a také prováděl studie na toto téma. [@cleveland_mcgill]  Jedená z nejvíc známých je studie, kterou provedli mezi svými studenty, na rozdíl ve vnímání koláčových a sloupcových grafů. Studenti systematicky odhadováli hodnoty sloupcového grafu přesnějí oproti kolačovému grafu. Z tohoto důvodu se tato forma grafů nepoužívá ve vážných kvantitativních výzkumech. [@cleveland_priceonomics] Ve svých prácích *Visualizing data* z roku 1993 a *The Elements of Graphing Data* z roku 1994 Cleveland se zabýval principy visualizace. Nekteré z těchto principů se schodují s principy vymezené Tuftem, avšak práce Clevelanda v této oblasti předcházela práci Tufte. Přehled zásad a principů dle Clevelandů by se se dalo zhrnout následně [@cleveland1994]: 

* **Jasná vize**
  + Data by měla vyčnívat, vyhnout se vykreslení nadbytečných prvků (neboli tvorbě *chartjunk*).
  ...
  + Popisky dat by neměli  zasahovat do dat a nesmějí znepřehlednovat graf. 
