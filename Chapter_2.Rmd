...
\qquad Pro vytváření základních grafů v R používáme vestavěný balíček `graphics` [@graphics], který obsahuje mnoho užitečných funkcí pro tvorbu grafických prvků. Tato kapitola se soustředí na tento balíček, zatímco v kapitole [4](#pokrocila) jsou popsány funkce dalších široce používaných balíčků (například `lattice` [4.1.2](#lattice) či `ggplot2` [4.1.3](#ggplot)), které nabízí podobné funkce, avšak s různým rozsahem nastavení [@teetor2011].
