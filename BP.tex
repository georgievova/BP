...
důležité funkce pro práci s útvary povrchových vod, vypočet bilanci,
m-denních vod atd. Nainstalovat balíček lze pomocí příkazu
\texttt{devtools::install\_github("KVHEM/CatCa")}. V rámci tvorby
aplikace byly do tohoto balíčků přidány také funkce pro připravů dat.
...
obsahuje funkci \enquote{getpath} pro nastavení pracovních cest k
uložišti dat. Pokud cesta není nastavena pomocí funkce \enquote{getpath}
je nutné jí uložit manuálně do proměnné \texttt{.datadir}.
