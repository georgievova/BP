...
```{r density_qq_plot, echo=FALSE, out.width='95%', fig.align='center', fig.cap="\\label{fig12} Vztah hustoty rozdělení a Q-Q grafu pro různá narušení normality", fig.pos='H', warning=FALSE}
x1 <-  rlnorm(45,0,.6)
x2 <-  -rlnorm(45,0,.6)
x3 <- runif(300,-2,2)
