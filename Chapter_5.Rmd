...
Aplikace je přístupná na [serveru](https://shiny.fzp.czu.cz/KVHEM/HAMR/)^[https://shiny.fzp.czu.cz/KVHEM/HAMR/] nebo ji lze také [stáhnout](https://github.com/KVHEM/Sucho)^[https://github.com/KVHEM/Sucho]. Repositář na [github](https://github.com/)^[https://github.com/] obsahuje následující soubory:
